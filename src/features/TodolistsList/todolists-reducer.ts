...
export const { changeTodolistTitle, changeTodolistFilter, changeTodolistEntityStatus, clearTodoData } = slice.actions
...
export const todosThunks = { fetchTodos, removeTodolist, addTodolist }
